...
import Models.Algorithms.SortingAlgorithms.ISorterModel;
...
public class AlgorithmController implements IAlgorithmController {
    ...
    public void InitController(AlgorithmModel model, AlgorithmView view){
        this.model = model;
        this.view = view;
        InitView();
    ...
    protected ActionListener updateDataSetActionListener() {
        return new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                ArrayList<Panel> panels = ((ISorterModel) model).run(DataAccess.GetData());
