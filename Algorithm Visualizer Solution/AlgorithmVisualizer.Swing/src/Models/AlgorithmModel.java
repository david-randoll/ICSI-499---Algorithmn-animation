...
public class AlgorithmModel implements IAppTimer {
    ...
    protected void UpdateBorderColorAndAddToOutput(RectangleElement[] dataSetRectangle, ArrayList<Shared.Components.Panel> output, int[] indexes, String instruction, Color color) {
